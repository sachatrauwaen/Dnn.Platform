...
namespace DotNetNuke.Web.Mvc.Skins
{
    ...
    {
        public static IHtmlString Privacy(this HtmlHelper<DotNetNuke.Framework.Models.PageModel> helper, string text = "", string cssClass = "SkinObject", string rel = "nofollow")
        {
